...
class Job {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (clientFeedback != null)
      map['client_feedback'] = clientFeedback!.toMap();
    return map;
  }
  ...
  factory Job.fromMap(String id, Map<String, dynamic> map) {
    ...
    return Job(
      ...
      workerFeedback: map['worker_feedback'] != null
          ? JobFeedback.fromMap(map['worker_feedback'] as Map<String, dynamic>)
          : null,
      clientFeedback: map['client_feedback'] != null
          ? JobFeedback.fromMap(map['client_feedback'] as Map<String, dynamic>)
          : null,
    );
  }
  ...
  bool get canBeCancelled =>
      status == JobStatus.requested || status == JobStatus.quoted;
  ...
  String? get formattedScheduledDate =>
      scheduledAt != null ? _formatDate(scheduledAt!) : null;
  String? get formattedStartedDate =>
      startedAt != null ? _formatDate(startedAt!) : null;
  ...
  Job copyWith({
    ...
    JobBill? bill,
    DateTime? startedAt,
    JobFeedback? workerFeedback,
    JobFeedback? clientFeedback,
  }) {
    return Job(
      id: id ?? this.id,
  ...
  @override
  String toString() =>
      'Job(id: $id, service: $serviceName, status: $statusLabel)';
